//
//  Pocket SDR - RF frontend v.3 firmware for EZ-USB FX3
//
//  References:
//
...
static uint32_t dcnt_limit = 16368 / 2 - 2;

// IO ports definitions
static const uint8_t port_inp[] = {LOCK_A, LOCK_B, LOCK_C, LOCK_D, 0};
static const uint8_t port_out[] = {RF_SW_A, RF_SW_B, RF_SW_C, RF_SW_D,
    USB3_PORT_SEL, SCLK, SDATA, CSN_A, CSN_B, CSN_C, CSN_D, LED1, LED2, 0};
