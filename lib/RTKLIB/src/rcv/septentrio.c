...
*
*          Copyright (C) 2020-2023 by Tomoji TAKASU
*
* reference :
*     [1] Septentrio, mosaic-X5 reference guide applicable to version 4.8.0 of
*         the firmware, June 4, 2020
*     [2] Septentrio, mosaic-X5 reference guide applicable to version 4.14.0 of
*         the firmware, May 22, 2023
*
* version : $Revision:$
*
...
*           2023/06/16  1.14 fix bug to decode signal no. in GNSS measurements
*                            expand signal number table by [2]
*-----------------------------------------------------------------------------*/
#include "rtklib.h"
