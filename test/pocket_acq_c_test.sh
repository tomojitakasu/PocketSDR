...
../bin/pocket_acq L1a.bin -f 24 -fi 6 -sig L1CP -prn 1-32,193-199
../bin/pocket_acq L1a.bin -f 24 -fi 6 -sig L1CD -prn 1-32,193-199
../bin/pocket_acq L1a.bin -f 24 -fi 6 -sig E1B  -prn 1-36
../bin/pocket_acq L1a.bin -f 24 -fi 6 -sig E1C  -prn 1-36
../bin/pocket_acq L1a.bin -f 24 -fi 6 -sig B1CP -prn 19-46
../bin/pocket_acq L1a.bin -f 24 -fi 6 -sig B1CD -prn 19-46
...
../bin/pocket_acq L5.bin -f 24 -sig B2AP -prn 19-46
../bin/pocket_acq L5.bin -f 24 -sig B2AD -prn 19-46
../bin/pocket_acq L5.bin -f 24 -sig I5S  -prn 1-7
...
../bin/pocket_dump -t 10 G1a.bin G3.bin -c ../conf/pocket_G1G3_24MHz.conf

../bin/pocket_acq G1a.bin -f 24 -sig G1CA  -prn -7-6
../bin/pocket_acq G3.bin  -f 24 -sig G3OCD -prn 1-24
../bin/pocket_acq G3.bin  -f 24 -sig G3OCP -prn 1-24
...
../bin/pocket_acq E5b.bin -f 24 -sig B2BI -prn 19-46

../bin/pocket_dump -t 10 B1I.bin B2I.bin -c ../conf/pocket_B1IB2I_12MHz.conf

../bin/pocket_acq B1I.bin -f 12 -sig B1I -prn 1-37
../bin/pocket_acq B2I.bin -f 12 -sig B2I -prn 1-37

../bin/pocket_dump -t 10 B1Ia.bin B3I.bin -c ../conf/pocket_B1IB3I_24MHz.conf

../bin/pocket_acq B1Ia.bin -f 24 -sig B1I -prn 1-63
../bin/pocket_acq B3I.bin  -f 24 -sig B3I -prn 1-63
