...
../python/pocket_acq.py L1a.bin -f 24 -fi 6 -np -sig B1CP -prn 19-46
../python/pocket_acq.py L1a.bin -f 24 -fi 6 -np -sig B1CD -prn 19-46
...
../python/pocket_acq.py L5.bin -f 24 -np -sig B2AP -prn 19-46
...
../python/pocket_acq.py G1a.bin -f 24 -np -sig G1CA  -prn -7-6
../python/pocket_acq.py G3.bin  -f 24 -np -sig G3OCD -prn 1-24
../python/pocket_acq.py G3.bin  -f 24 -np -sig G3OCP -prn 1-24
...
../python/pocket_acq.py E5b.bin -f 24 -np -sig B2BI -prn 19-46
...
../python/pocket_acq.py B1Ia.bin -f 24 -np -sig B1I -prn 1-63
