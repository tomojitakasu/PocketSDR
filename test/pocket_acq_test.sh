...
../python/pocket_acq.py L1.bin -f 8 -fi 2 -np -sig L1CA -prn 1-32,193-199
../python/pocket_acq.py L1.bin -f 8 -fi 2 -np -sig L1CA -prn 120-158
../python/pocket_acq.py L1.bin -f 8 -fi 2 -np -sig L1S  -prn 184-191
../python/pocket_acq.py L2.bin -f 8 -fi 2 -np -sig L2CM -prn 1-32,193-199

../bin/pocket_dump -t 10 L1a.bin L5.bin -c ../conf/pocket_L1L5_24MHz.conf

../python/pocket_acq.py L1a.bin -f 24 -fi 6 -np -sig L1CP -prn 1-32,193-199
../python/pocket_acq.py L1a.bin -f 24 -fi 6 -np -sig L1CD -prn 1-32,193-199
../python/pocket_acq.py L1a.bin -f 24 -fi 6 -np -sig E1B  -prn 1-36
../python/pocket_acq.py L1a.bin -f 24 -fi 6 -np -sig E1C  -prn 1-36
../python/pocket_acq.py L1a.bin -f 24 -fi 6 -np -sig B1CP -prn 1-63
../python/pocket_acq.py L1a.bin -f 24 -fi 6 -np -sig B1CD -prn 1-63
...
../python/pocket_acq.py L5.bin -f 24 -np -sig B2AP -prn 1-63
../python/pocket_acq.py L5.bin -f 24 -np -sig B2AD -prn 1-63
...
../python/pocket_acq.py E5B.bin -f 24 -np -sig B2BI -prn 1-63
