#!/bin/bash
#
#  test driver for pocket_trk
#

../bin/pocket_dump -t 30 L1.bin L2.bin -c ../conf/pocket_L1L2_4MHz.conf

../bin/pocket_trk L1.bin -f 4 -sig L1CA -prn 1-32,193-199
../bin/pocket_trk L1.bin -f 4 -sig L1CA -prn 120-158
../bin/pocket_trk L1.bin -f 4 -sig L1S  -prn 184-191
../bin/pocket_trk L2.bin -f 4 -sig L2CM -prn 1-32,193-199
...
../bin/pocket_trk L5.bin -f 24 -sig L5I  -prn 120-158
../bin/pocket_trk L5.bin -f 24 -sig L5Q  -prn 120-158
../bin/pocket_trk L5.bin -f 24 -sig L5SI -prn 184-189
...
../bin/pocket_trk L5.bin -f 24 -sig I5S  -prn 1-7

../bin/pocket_dump -t 30 L1b.bin L6.bin -c ../conf/pocket_L1L6_12MHz.conf

../bin/pocket_trk L6.bin -f 12 -sig L6D -prn 193-199
../bin/pocket_trk L6.bin -f 12 -sig L6E -prn 203-209
../bin/pocket_trk L6.bin -f 12 -sig E6B -prn 1-36
../bin/pocket_trk L6.bin -f 12 -sig E6C -prn 1-36
...
../bin/pocket_trk E1.bin  -f 24 -sig E1B  -prn 1-36
...
../bin/pocket_trk B1I.bin -f 12 -sig B1I -prn 1-61
